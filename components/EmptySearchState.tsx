...
export function EmptySearchState({
  ...
  return (
    ...
    >
      {/* Main Card */}
      <div className={`bg-gradient-to-br from-white via-white to-orange-50/50 rounded-3xl border border-orange-100/50 shadow-lg shadow-orange-100/20 ${compact ? 'p-4' : 'p-8'}`}>
        {!compact && (
          <>
            {/* Decorative Elements */}
        ...
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: compact ? 0.1 : 0.5 }}
        ...
        {!compact && (
          <>
            ...
            <motion.div
              ...
              className="text-center space-y-3 mt-6 mb-6"
            >
